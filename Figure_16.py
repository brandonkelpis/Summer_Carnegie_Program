...
sys.path.append("/Users/brandonkelpis/Carnegie/adiabatic-tides/")
...
def angle_histograms(nsel=1000, d=788280, nalpha=100): #811726 #8200
...
# This is for the tangent radius. 

# ticks = [ 0.4, 8.3, 14] To place the tangent radius as the same points as 
# ax2 = ax1.twiny()
# # ax2.set_xscale ('log')
# ax2.set_xlim(ax1.get_xlim()) #### holy fuck....was just ax
...
# print(angles)
# distance = 803 * (angles*np.pi/180)

# ax2.set_xticklabels([f"{d:.0f}" for d in distance])
# ax1.set_xscale('log')

# distance = 803 * (angles*np.pi/180)

# ax2.set_xticks(distance[::3])
# ax2.set_xticks(distance)
# ax2.xaxis.set_major_formatter(StrMethodFormatter('{x:.3f}'))
