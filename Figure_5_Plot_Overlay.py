...
i_NFW = np.argmax(radii > 213)
i_total = np.argmax(radii > 213)
i_baryons = np.argmax(radii > 213)
i_stellar_disk = np.argmax(radii > 213)
i_bulge = np.argmax(radii > 213)
...
plt.plot(radii[:i_stellar_disk],y2[:i_stellar_disk], label = 'Stellar Disk', color = 'cornflowerblue')

plt.plot(radii[:i_bulge],y1[:i_bulge], label = 'Bulge', color = 'magenta')

plt.plot(radii[:i_baryons],baryon[:i_baryons], label = 'All Baryons', color = 'lime')

plt.plot(radii[:i_total],y6[:i_total], label = 'Total', color = 'darkgoldenrod')



plt.plot (radii[:i_NFW], y7[:i_NFW], label = 'NFW', color = 'dimgrey')

plt.plot(radii[:i_stellar_disk], stellar_mass[:i_stellar_disk], label = 'Stellar Disk Stücker', color = 'blue')
plt.plot(radii[:i_bulge], bulge_mass[:i_bulge], label = 'Bulge Stücker', color = 'purple')

plt.plot (radii[:i_NFW], NFW_mass[:i_NFW], label = 'NFW Stücker', color = 'black')
plt.plot (radii[:i_baryons],baryon_mass[:i_baryons], label = 'All Baryons Stücker', color = 'green')
plt.plot (radii[:i_total],total_mass[:i_total], label ='Total Stücker', color = 'orange')
