...
import numpy as np
import sys
sys.path.append("/Users/brandonkelpis/Carnegie/Paper_Code/cusp_encounters")
sys.path.append("/Users/brandonkelpis/Carnegie/Paper_code/adiabatic_tides/")
...
# Purpose of this code is to use all the altered parameters of Stucker's code and recreate Figure 15 and 16

# Lots of stored caches to speed up the computation process.

cachedir = "/Users/brandonkelpis/Desktop/Carnegie/Complete_Code/caches"
...
Beff= em.sample_effective_B_hist(shape, Bminfac=1e-4, p=1.2, initial_sample=100000, cachefile="/Users/brandonkelpis/Desktop/Carnegie/Complete_Code/caches/Beff_hist.hdf5") * Bstar 
